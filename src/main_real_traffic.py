...
def offer(allowed_deviation, trace_treshold, lower_boundary, anomaly_treshold, cohens_boundary, model_epsilon, size):
    ...
    log_source("DataImported/traffic.xes").pipe().subscribe(lambda x: my_process_history.concept_Drift_detection(x))
...
if __name__ == "__main__":
        ...
        download_blob("experiments-data-bucket68", "Road_Traffic_Fine_Management_Process.xes", "DataImported/traffic.xes"  )
