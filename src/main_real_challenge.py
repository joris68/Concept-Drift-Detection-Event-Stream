...
def offer(allowed_deviation, trace_treshold, lower_boundary, anomaly_treshold, cohens_boundary, model_epsilon, size):
    ...
    log_source("Data/real-world/BPI Challenge 2017.xes").pipe().subscribe(lambda x: my_process_history.concept_Drift_detection(x))
...
if __name__ == "__main__":
        ...
        try:
            with open('./ExperimentsDocker/challenge.csv', 'w',  newline='') as file:
        ...
        for size in trace_map_sizes:
                ...
                try:
                    with open('./ExperimentsDocker/challenge.csv', 'a',  newline='') as file:
        ...
        upload_blob("experiments-bucket68", './ExperimentsDocker/challenge.csv', 'challenge.csv')